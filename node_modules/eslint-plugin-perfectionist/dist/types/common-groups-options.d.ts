...
> = ({
  /**
   * Fallback sorting configuration used when primary sort returns equal.
   * Useful for stable sorting when elements have identical primary sort
   * values.
   */
...
> = {
  ...
  group: string[] | string
  /**
   * Same as `type` in CommonOptions - Sorting algorithm to use for this
   * group.
   */
  type?: CustomTypeOption
  /**
